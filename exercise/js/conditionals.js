...
output.textContent = `You have earned a  ${breakDuration} minutes break.`;
...
function setWeather() {
  ...
  if (choice === "sunny" && temperature >= 15) {
    comments.textContent =
      "It is sunny and warm — time to find your sunglasses!";
...
function getWindSpeed() {
  ...
  switch (speed) {
    ...
    case 100:
      // 100 km/h
      windComment.textContent =
        speed + "km/h - Holy schmoly! Hold on to your hat!";
      break;
    case 75:
      // 75 km/h
...
coffeeBreak
  ? (breakMessage.textContent = "Break time!")
  : (breakMessage.textContent = "Keep working.");
